importScripts('./narration-manifest.js?v=29.0.0');

const CACHE_NAME = 'danco-workforce-standard-plus-v29-20260909';
...
const CORE_ASSETS = [
  ...
  './app.css?v=29.0.0',
  './app.js?v=29.0.0',
  './narration-manifest.js?v=29.0.0',
  './manifest.webmanifest?v=29.0.0',
  './danco-logo.webp',
...
const NARRATION_ASSETS = [
  './narration-en.mp3?v=29.0.0',
  './narration-es.mp3?v=29.0.0'
];
  ...
  if (event.request.mode === 'navigate') {
    event.respondWith(
      fetch(event.request)
        ...
        .catch(() => caches.match('./index.html?v=29.0.0'))
    );
    return;
  }
